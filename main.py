...
def generate_tutorial(components):
    response = openai.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": f"""Suggest a recipe using the items listed 
             as available. Make sure you have a nice name for this recipe listed 
             at the start. Also, include a funny version of the name of the recipe 
             on the following line. Then share the recipe in a step-by-step manner. 
             In the end, write a fun fact about the recipe or any of the items used 
             in the recipe. Here are the items available: {components}, Haldi, 
             Chilly Powder, Tomato Ketchup, Water, Garam Masala, Oil"""},
        ]
    )
            ...
            <body>
                <div class="container">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="output" class="mb-0" style="white-space: pre-wrap;">{{output | safe}}</div> 
                        </div>
                    </div>
                </div>
            </body>
